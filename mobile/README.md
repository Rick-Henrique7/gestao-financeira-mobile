...
> 2. Salva como `docs/screenshot-home.png` (ou outro nome)
> 3. Faz commit: `git add docs/ && git commit -m "docs: add home screenshot"`
> 4. A imagem aparece automaticamente aqui

<p align="center">
  <img src="docs/screenshot-home.png" alt="Tela inicial do app" width="320" />
</p>
